...
SELECT Count(*) FROM employees WHERE last_name LIKE '%E';
-- There are 899 employees who start and end with an e. There are 24292 employees whose last names end with the letter e. Can also use LIKE 'E%e'
SELECT Count(*) FROM employees where hire_date BETWEEN '1990-01-01' AND '1999-12-31';
-- There are 135214 employees that where hired in the 90s. or LIKE '199%';
Select Count(*) FROM employees where birth_date LIKE '%-12-25';
-- There are 842 employees who were born on Christmas. or LIKE '%12-25'
SELECT Count(*) FROM employees where hire_date BETWEEN '1990-01-01' AND '1999-12-31' AND birth_date LIKE '%-12-25';
-- 362 employees born in the 90s on christmas
