...
select hire_date, datediff(now(),hire_date) as days_as_co from employees where hire_date between '1990-01-01' and '1999-12-31' and birth_date like '%12-25';

-- Find the smallest and largest current salary from the salaries table.

select min(salary),max(salary) from salaries where to_date = '9999-01-01';
-- another option where to_date > now()
